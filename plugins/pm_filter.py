...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await query.answer('𝐔𝐧𝐛𝐥𝐨𝐜𝐤 𝐭𝐡𝐞 𝐛𝐨𝐭 !', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url=(MAIN_CHANNEL))
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url=(MAIN_CHANNEL)),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url=(MAIN_CHANNEL)),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url=(MAIN_CHANNEL))
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
