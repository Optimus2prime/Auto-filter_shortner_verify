...
NOR_IMG = environ.get('NOR_IMG', "https://telegra.ph/file/14ea49625341fb27b4df6.jpg")
...
HOW_TO_VERIFY = environ.get("HOW_TO_VERIFY", "download video Tele-Graph link")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'mdisklink.link')
SHORTLINK_API = environ.get('SHORTLINK_API', 'shortner api')
